 ...
 * */
 ...
 #define CONN_TABLE_NUM_BUCKETS 16384*72
 ...
 __declspec(emem export scope(global)) struct conn_table_bucket conn_table[CONN_TABLE_NUM_BUCKETS];
 ...
 int main(void)
 {
    ...
    //  if (__ctx() == 0) {
         ...
         for (;;) {
             ...
             // Write access counter to the calculated bucket and entry
             conn_table[bucket_idx].four_tuple_hash_entry[entry_idx] = access_counter;
